...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.1, -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.2,
	GOLD_TO_CASH_RATE = 10, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 2, -- Multiplier for how much money gold pays to pops
...
economy = {
	...
	SECOND_RANK_BASE_SHARE_FACTOR = 0.0,
	CIV_BASE_SHARE_FACTOR = 0.0,
	UNCIV_BASE_SHARE_FACTOR = 0.0,
	...
	FACTORY_PURCHASE_DRAWDOWN_FACTOR = 0.0		-- the % a factory will reduce its input purchases each day if it did not sell all its goods (also used for scaling up production if all goods are sold)
},
...
pops = {
	...
	MIL_LACK_EVERYDAY_NEED = 0.2,
	MIL_HAS_EVERYDAY_NEED = -0.2,
	MIL_HAS_LUXURY_NEED = -0.4,
	MIL_NO_LIFE_NEED = 0.4,
...
ai =
{
	...
	PRODUCTION_WEIGHT = 0.9, -- ai weight for new production
	...
	CHANCE_BUILD_NAVAL_BASE = 0.8,
	CHANCE_BUILD_FORT = 0.6,
	CHANCE_INVEST_POP_PROJ = 1.0,
	CHANCE_FOREIGN_INVEST = 0.7,
