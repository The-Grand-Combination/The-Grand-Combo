...
country = {
	...
	COLONIZATION_RELEASE_DOMINION_COST = 500,
...
economy = {
	...
	CAPITALIST_BUILD_FACTORY_STATE_EMPLOYMENT_PERCENT = 0.6, -- Capis don't build factories if less than this percent is employed in existing factories
...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.45, -- fraction of ships in the navy that should be ships of the line
	AI_LIGHTSHIP_PROPORTION = 0.3, -- fraction of ships in the navy that should be cruisers, frigates etc
	AI_TRANSPORT_PROPORTION = 0.35, -- fraction of ships in the navy that should be should be transports
	...
	AI_ESCORT_RATIO = 2.5, -- ratio of escorts to transports in invasion fleets
	AI_ARMY_TAXBASE_FRACTION = 0.15, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 0.15, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
...
ai =
{
	...
	AGGRESSION_BASE = 7, -- general AI aggression
