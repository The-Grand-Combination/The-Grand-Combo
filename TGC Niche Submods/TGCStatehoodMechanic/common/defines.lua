defines = {
	...
	country = {
		...
		MAX_SUPPRESSION = 100,
		PRESTIGE_HIT_ON_BREAK_COUNTRY = -0.05, -- percentage reduction when country gets taken by rebels
	...
	diplomacy = {
		...
		PRESTIGE_ADD_TO_SPHERE = 0.025,
		PRESTIGE_RELEASE_PUPPET = 0.025,
		PRESTIGE_MAKE_PUPPET = 0.025,
		PRESTIGE_DISARMAMENT = 0.025,
		PRESTIGE_DESTROY_FORTS = 0.025,
		PRESTIGE_DESTROY_NAVAL_BASES = 0.025,
		PRESTIGE_REPARATIONS = 0.025,
		PRESTIGE_TRANSFER_PROVINCES = 0.01,
		PRESTIGE_REMOVE_CORES = 0,
		PRESTIGE_PRESTIGE = 0.025,
		PRESTIGE_CONCEDE = 0.01,
		PRESTIGE_STATUS_QUO = 0.025,
		PRESTIGE_ANNEX = 0.01,
		PRESTIGE_DEMAND_STATE = 0.01,
		PRESTIGE_CLEAR_UNION_SPHERE = 0.05,
		PRESTIGE_GUNBOAT = 0.01, -- Prestige for debt collection
		PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = 0.01,
		PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = 0.01,
		PRESTIGE_COLONY = 0.01,
		...
		WAR_FAILED_GOAL_PRESTIGE = -0.025,
	...
	pops = {
		...
		STATE_CREATION_ADMIN_LIMIT = 1.012,
