defines = {
	...
	diplomacy = {
		...
		AT_WAR_TENSION_DECAY = -1, -- for each potentially interested GP at war (value is if all possible GPs are at war)
		TENSION_ON_CB_DISCOVERED = 0,
		TENSION_ON_REVOLT = 0,
		TENSION_WHILE_CRISIS = -1.0,
		CRISIS_COOLDOWN_MONTHS = 9999,
		...
		CRISIS_TEMPERATURE_PARTICIPANT_FACTOR = 0, -- How much faster a crisis heats up if all interested parties have taken sides (linear, multiplied)
