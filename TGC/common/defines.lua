defines = {
	...
	economy = {
		...
		EMPLOYMENT_FIRE_LOWEST = 0.01,				-- we Fire pops no slower then x% of total required per day			-- we Fire pops no slower then x% of total required per day
		
		TRADE_CAP_LOW_LIMIT_LAND = 0.10, 				-- the lowest % the slider can go for land units
